...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-[rgba(96,212,200,0.04)] rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-[rgba(245,158,11,0.03)] rounded-full blur-3xl pointer-events-none" />
      ...
      >
        ...
        >
          ...
          <p className="text-sm text-[var(--fg-secondary)] mt-1">
            Become a node in the world&apos;s most interesting graph
          </p>
        </motion.div>
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-xs text-[var(--fg-muted)] uppercase tracking-wider">or sign up with email</span>
            <div className="flex-1 h-px bg-[var(--glass-border)]" />
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <motion.div
              ...
              transition={{ delay: 0.25, duration: 0.4 }}
            >
              <label htmlFor="name" className="block text-xs text-[var(--fg-secondary)] mb-1.5 font-medium">
                Display Name
              </label>
              <input
                id="name"
            ...
            >
              <label htmlFor="password" className="block text-xs text-[var(--fg-secondary)] mb-1.5 font-medium">
                Password
              </label>
              <input
                id="password"
            ...
            {error && (
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                className="text-xs text-[var(--hot)] bg-[rgba(249,112,102,0.1)] rounded-lg px-3 py-2"
              >
                {error}
              </motion.p>
            )}
